...
print(WORKING_DIR)
SYNSET_FILE = os.path.join(WORKING_DIR, 'data/imagenet_lsvrc_2015_synsets.txt')
METADATA_FILE = os.path.join(WORKING_DIR, 'data/imagenet_metadata.txt')
...
def export():
  ...
  with tf.Graph().as_default():
    ...
    # Run inference.
    logits, _, _ = inception_model.inference(images, NUM_CLASSES + 1)
