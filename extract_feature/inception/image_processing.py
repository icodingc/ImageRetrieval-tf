...
#TODO add filenames for extract features
...
def distort_color(image, thread_id=0, scope=None):
  ...
  with tf.op_scope([image], scope, 'distort_color'):
    ...
    #TODO rescale to [0.0,1.0]
    image = tf.clip_by_value(image, 0.0, 1.0)
    return image

#TODO just resize + flip + distort color
...
#TODO do not change,[you should do this when you extract feature]
...
def image_preprocessing(image_buffer, train, thread_id=0):
  ...
  # why eval_iamge() ?
  #TODO why this line can baozheng rescale to [-1,1]
...
def batch_inputs(dataset, batch_size, train, num_preprocess_threads=None,
  ...
  with tf.name_scope('batch_processing'):
    ...
    #TODO train for Random else FIFO
    if train:
