...
tf.app.flags.DEFINE_string('image', '/home/zhangxs/serving/models/inception/01018723.jpg', 'path to image in JPEG format')
...
def main(_):
  ...
  with open(FLAGS.image, 'rb') as f:
    ...
    #return numpy obj for KNN
    rst = np.array(result.scores)
    print rst[:3]
